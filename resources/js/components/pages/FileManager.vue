...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                headers:[
                    ...
                    { text: 'Department', value: 'email', sortable: false,},
                    { text: 'Category', value: 'department.department_name' },
                    { text: 'Permissions', value: 'role_id' },
                    { text: 'Date created', value: 'role_id' },
                    { text: 'Created by', value: 'role_id' },
        ...
        beforeMount(){
            ...
            url.get("department-documents/" +this.$store.getters['auth/user'].id,)
                .then((response)=>
                {
