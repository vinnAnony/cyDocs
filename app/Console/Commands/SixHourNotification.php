...
class SixHourNotification extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'emails:sixhoursupdate';
     ...
     * @var string
     */
    protected $description = 'Send email notification 6 hours before file access expiry';
